...
async function get_teacher_name(course_id) {
    const res = await axios.get("https://us-central1-mana-test-294607.cloudfunctions.net/app/courses/teacher/"+ course_id);
